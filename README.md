...
- **Sandbox0 execution.** Run agent CLIs in gVisor sandboxes with durable RootFS snapshots using `pip install 'bernstein[sandbox0]'` and `bernstein run --sandbox sandbox0 --allow-paid`. See [setup and validation](docs/sandbox/sandbox0.md).
